...
for frame = 1:numel(img_files),
    ...
    if(firstFrame)
      ...
      %目标的矩形框 [x,y,x+w,y+h]
        tracker.pT.bb=fromCentralPointToBB...
            (tracker.pT.posX,tracker.pT.posY,...
            tracker.pT.w,tracker.pT.h,size(im,2),size(im,1));
    ...
    occlusionState=[occlusionState ;tracker.cT.underOcclusion];
